...
const educationData: EducationItem[] = [
  {
    ...
    achievements: [
      ...
      "Research paper published in ACM conference",
  ...
  },
  {
    ...
    duration: "2015 - 2019",
    description: "Foundational studies in Computer Science with minor in Mathematics.",
    achievements: [
      "Dean's List for academic excellence",
      "Member of the Programming Competition Team",
  ...
  },
  {
    ...
    duration: "2011 - 2015",
    description: "College preparatory education with advanced placement courses in Mathematics, Physics, and Computer Science.",
    achievements: [
      "Valedictorian",
