      ...
      <div className="section-container">
        ...
        >
          ...
          <motion.div variants={childVariants} className="space-y-6">
            ...
            <motion.p variants={childVariants} className="text-foreground/80">
              My approach combines technical expertise with creative thinking to solve complex problems. 
              I believe in continuous learning and staying up-to-date with the latest technologies and design trends.
            </motion.p>
