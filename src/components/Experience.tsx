...
const experienceData: ExperienceItem[] = [
  {
    ...
    description: "Promoted study abroad programs through events and workshops, driving student engagement and participation.",
    responsibilities: [
      ...
      "Organize Events & Workshops – Coordinate and promote seminars, webinars, and informational sessions on studying abroad."
    ],
    link: "https://www.valmikigroup.com/"
  },
  {
    title: "ZSCALAR - Zero Trust Cloud SecurityVirtual Internship ",
    company: "AICTE Virtual Internship",
    duration: "April 2024 - June 2021",
  ...
  {
    title: "GOOGLE - Android DeveloperVirtual Internship",
    company: "AICTE Virtual Internship",
    duration: "September 2023 - November 2023",
    description: "Introduction to Android development, covering app design, coding, and deployment using Google’s best practices",
    responsibilities: [],
  ...
  return (
    ...
    >
      ...
      <div className="space-y-2">
        <h4 className="font-medium text-foreground/90">Key Responsibilities:</h4>
